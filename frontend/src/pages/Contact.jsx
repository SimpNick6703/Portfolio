...
const Contact = () => {
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="bg-gradient-to-br from-white to-blue-50 dark:from-gray-800 dark:to-gray-900 rounded-2xl shadow-xl p-8 border border-gray-200 dark:border-gray-700">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="space-y-6">
              <div className="flex items-center group">
                ...
                <div className="ml-4">
                  ...
                  <a href="mailto:harshluhaa@gmail.com" className="text-gray-900 dark:text-white hover:text-blue-600 dark:hover:text-blue-400 transition-colors duration-200">
              ...
              <div className="flex items-center group">
                ...
                <div className="ml-4">
                  ...
                  <a href="https://github.com/SimpNick6703" target="_blank" rel="noopener noreferrer" className="text-gray-900 dark:text-white hover:text-blue-600 dark:hover:text-blue-400 transition-colors duration-200">
              ...
              <div className="flex items-center group">
                ...
                <div className="ml-4">
                  ...
                  <a href="https://linkedin.com/in/harshluha" target="_blank" rel="noopener noreferrer" className="text-gray-900 dark:text-white hover:text-blue-600 dark:hover:text-blue-400 transition-colors duration-200">
          ...
          <div>
            <h3 className="text-xl font-semibold mb-6 bg-gradient-to-r from-gray-900 to-gray-600 dark:from-white dark:to-gray-300 bg-clip-text text-transparent">
              Send a Message
            </h3>
            <form className="space-y-6">
              ...
              <button 
                type="submit"
                className="w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white py-3 px-6 rounded-xl hover:from-blue-700 hover:to-purple-700 transform hover:scale-105 transition-all duration-200 shadow-lg font-medium"
              >
                Send Message
              </button>
              <p className="text-sm text-gray-500 dark:text-gray-400 text-center">
                Note: This form is for display purposes. Please use the email or social links above to contact me directly.
              </p>
            </form>
          </div>
        </div>
